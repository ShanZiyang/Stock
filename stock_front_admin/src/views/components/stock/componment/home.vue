    ...
    <div class="module-group">
      ...
      <div class="module mr0">
        ...
        <Table
            ...
            :tableColumnData="newsTableColumnData"

            @columnClickCallBack="callBackTwo"
        />
<!--                <ul class="news-list">-->
<!--                  <li-->
...
export default {
      ...
      newsTableColumnData: [
        {
          ...
          extraTextBefore: "",
          extraTextAfter: "",
          defaults: "A股三大指数收涨：民航与券商板块领涨 北向资金净流入近60亿"
        }, {
          prop: "time",
          label: "新闻时间",
          isDifferentStates: false,
          ...
          extraTextBefore: "",
          extraTextAfter: "",
          defaults: "https://finance.sina.com.cn/stock/s/2023-07-27/doc-imzeaqie6611195.shtml"
        },
  ...
  methods: {
    ...
    stockNews() {
      let that = this;
      stockNews().then(data => {
        // console.log("数据返回成功 - 新闻列表");
        // console.log(data);
        this.newsTableData = data.data.data
