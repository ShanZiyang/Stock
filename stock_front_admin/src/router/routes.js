...
const routes = [
	...
	},
	{
		path: '/bill',
		name:'bill',
		component: () => import(/* webpackChunkName: "bill" */ '@/views/components/bill/index.vue')
	},
	{
		path: '/orders',
		name:'orders',
		component: () => import(/* webpackChunkName: "orders" */ '@/views/components/orders/index.vue')
	},
	{
		path: '/pay',
		name:'pay',
		component: () => import(/* webpackChunkName: "pay" */ '@/views/components/pay/index.vue')
	}
