package com.ys.stock.security.config;

import com.ys.stock.security.filter.JwtAuthorizationFilter;
import com.ys.stock.security.filter.JwtLoginAuthenticationFilter;
import com.ys.stock.security.handler.AccessAnonymousEntryPoint;
import com.ys.stock.security.handler.StockAccessDeniedHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()//设置需要认证才能访问的请求
                ...
                .antMatchers("/login", "/register", "/captchaImage","/api/ali-pay/trade/notify","/api/uploadImg").permitAll()
                // 静态资源，可匿名访问
